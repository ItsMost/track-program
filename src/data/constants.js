...
export const INITIAL_LIBRARY = {
  drills: [
    ...
    { id: 'sts4', title: 'Lying Banded Psoas March', details: 'Lying on back with resistance band around feet, pull one knee to chest while holding the other leg straight and stable. Highly specific hip flexor activation.', type: 'strength_single_leg', percentage: 65, sets: '3', reps: '10', distance: null, rest: '60s', unit: 'reps' },
    { id: 'sts5', title: 'Standing Cable Hip Flexion', details: 'Ankle strap attached to low cable. Explode knee upward to hip height, then lower under control to build sprinting drive power.', type: 'strength_single_leg', percentage: 75, sets: '3', reps: '8', distance: null, rest: '75s', unit: 'reps' },
    { id: 'sts6', title: 'Kettlebell Standing Knee Drive', details: 'Insert foot in kettlebell handle. Standing tall, drive knee aggressively upward to 90 degrees. Mimics high-knee sprint mechanics.', type: 'strength_single_leg', percentage: 70, sets: '3', reps: '8', distance: null, rest: '60s', unit: 'reps' },
    { id: 'sts7', title: 'Resisted Wall Drill Knee Drives', details: 'Leaning against a wall at 45-degree angle. Loop band around feet and drive knees explosively in a piston motion.', type: 'strength_single_leg', percentage: 70, sets: '4', reps: '10', distance: null, rest: '75s', unit: 'reps' },
    { id: 'sts8', title: 'Hanging Weighted Single-Leg Knee Raises', details: 'Hanging from a pull-up bar, raise one knee to chest with a dumbbell gripped between feet. Overloads hip flexors at full extension.', type: 'strength_single_leg', percentage: 75, sets: '3', reps: '8', distance: null, rest: '90s', unit: 'reps' },
    { id: 'sts9', title: 'Standing High-Tension Band Hip Flexion', details: 'Anchor resistance band behind you, loop around ankle. Explode foot forward and knee up into sprinting posture.', type: 'strength_single_leg', percentage: 60, sets: '3', reps: '12', distance: null, rest: '60s', unit: 'reps' },
    { id: 'sts10', title: 'Seated Kettlebell Hip Flexor Lift', details: 'Sit tall on box with leg straight. Lift foot carrying a kettlebell over an obstacle. Targets psoas major in deep hip flexion.', type: 'strength_single_leg', percentage: 65, sets: '3', reps: '8', distance: null, rest: '60s', unit: 'reps' },
    { id: 'sts11', title: 'Plank with Banded Knee-to-Chest Drives', details: 'Push-up plank position. Pull knee to chest against band resistance, maintaining flat spine and stable hips.', type: 'strength_single_leg', percentage: 60, sets: '3', reps: '10', distance: null, rest: '60s', unit: 'reps' },
    { id: 'sts12', title: 'Partner-Resisted A-Skip Knee Drives', details: 'Perform single-leg A-skip drives while a partner resists knee elevation to develop specific hip flexor power.', type: 'strength_single_leg', percentage: 80, sets: '3', reps: '10', distance: null, rest: '60s', unit: 'reps' },
    { id: 'sts13', title: 'Single-Leg Hip Thrust (Weighted)', details: 'Unilateral hip extension. Shoulders on bench, elevate one leg, drive hips upward against a dumbbell/plate for glute power.', type: 'strength_single_leg', percentage: 75, sets: '3', reps: '8', distance: null, rest: '90s', unit: 'reps' },
    ...
    { id: 'std4', title: 'Cable Reverse Squat (Double Knee Pull)', details: 'Lie on back facing cable stack, strap ankles, pull both knees aggressively to chest against resistance to strengthen hip flexors.', type: 'strength_double_leg', percentage: 70, sets: '3', reps: '10', distance: null, rest: '75s', unit: 'reps' },
    { id: 'std5', title: 'Barbell Hip Thrust (Heavy)', details: 'Maximum barbell hip thrust. Load glutes and hamstrings at short muscle lengths to build horizontal sprinting power.', type: 'strength_double_leg', percentage: 85, sets: '4', reps: '6', distance: null, rest: '2m', unit: 'reps' },
    { id: 'std6', title: 'Glute Ham Raise (GHR)', details: 'Bodyweight kneeling extension from GHD machine. Strengthens hamstrings at both knee and hip joint extensions.', type: 'strength_double_leg', percentage: 80, sets: '3', reps: '6', distance: null, rest: '90s', unit: 'reps' },
    { id: 'std7', title: 'Kettlebell Swing (Explosive Hinge)', details: 'Heavy kettlebell swings focusing on snapping hips forward dynamically. Builds ballistic hip extension power.', type: 'strength_double_leg', percentage: 80, sets: '4', reps: '10', distance: null, rest: '90s', unit: 'reps' },
    { id: 'std8', title: 'Deficit Romanian Deadlift (RDL)', details: 'Perform RDL standing on an elevated platform for deeper range of motion. Targets deep hamstring/glute extension stretch.', type: 'strength_double_leg', percentage: 75, sets: '4', reps: '8', distance: null, rest: '2m', unit: 'reps' },
    ...
    // === ANAEROBIC LACTIC POWER (5 DRILLS) ===
    ...
    // === EXTENSIVE TEMPO (6 DRILLS - 65-75% INTENSITY) ===
    ...
    // === INTENSIVE TEMPO (5 DRILLS - 75-85% INTENSITY) ===
    ...
    // === VBT & FORCE-VELOCITY CURVE DRILLS (16 SPECIALIZED DRILLS) ===
    // 1. Starting Strength / Speed (> 1.30 m/s)
    { id: 'vbt1', title: 'Ballistic Landmine Push-Press (Speed)', details: 'Explosive unilateral landmine press @ 35-40% 1RM. Target Mean: >1.35 m/s, Peak: >2.05 m/s. 10% velocity loss cutoff. Maximizes initial rate of force development (RFD).', type: 'power_starting_strength', percentage: 40, sets: '3', reps: '4', rest: '2m', unit: 'reps', targetVelocity: '1.35', peakVelocity: '2.05', velocityLoss: '10%' },
    { id: 'vbt2', title: 'Medicine Ball Overhead Backward Toss (VBT Track)', details: 'Explosive triple extension launching 4kg ball backwards. Target Peak: >2.40 m/s. Focus on hip snap for sprint acceleration.', type: 'power_starting_strength', percentage: 30, sets: '4', reps: '3', rest: '90s', unit: 'reps', targetVelocity: '1.50', peakVelocity: '2.40', velocityLoss: '10%' },

    // 2. Speed-Strength (1.00 - 1.30 m/s)
    { id: 'vbt3', title: 'Barbell Jump Squat (Speed-Strength)', details: 'Loaded jump squat with barbell @ 30-35% 1RM. Target Mean: 1.15-1.30 m/s, Peak: >2.10 m/s. 10% velocity loss cutoff to protect CNS.', type: 'power_speed_strength', percentage: 35, sets: '4', reps: '4', rest: '2.5m', unit: 'reps', targetVelocity: '1.20', peakVelocity: '2.15', velocityLoss: '10%' },
    { id: 'vbt4', title: 'Trap Bar Explosive High Jumps', details: 'Vertical jumps from neutral grip trap bar @ 30-35% 1RM. Target Mean: 1.25 m/s, Peak: 2.20 m/s. 10% velocity loss cutoff.', type: 'power_speed_strength', percentage: 35, sets: '4', reps: '3', rest: '3m', unit: 'reps', targetVelocity: '1.25', peakVelocity: '2.20', velocityLoss: '10%' },
    { id: 'vbt5', title: 'Hang Power Snatch from Mid-Thigh', details: 'Olympic snatch from power position @ 65-70% 1RM. Target Mean: 1.25 m/s, Peak: >1.85 m/s. 10% velocity loss cutoff.', type: 'power_speed_strength', percentage: 70, sets: '4', reps: '2', rest: '3m', unit: 'reps', targetVelocity: '1.25', peakVelocity: '1.85', velocityLoss: '10%' },
    { id: 'vbt6', title: 'Dynamic Effort Bench Press with Bands', details: 'Bench press @ 50-55% 1RM + accommodating band tension. Target Mean: 1.05 m/s, Peak: 1.35 m/s. 10% cutoff for rapid upper limb velocity.', type: 'power_speed_strength', percentage: 55, sets: '5', reps: '3', rest: '90s', unit: 'reps', targetVelocity: '1.05', peakVelocity: '1.35', velocityLoss: '10%' },

    // 3. Strength-Speed (0.75 - 1.00 m/s)
    { id: 'vbt7', title: 'Hang Power Clean (Strength-Speed)', details: 'Olympic clean from knees @ 75-80% 1RM. Target Mean: 1.10 m/s, Peak: 1.65 m/s. 10% velocity loss cutoff. Maximizes power output.', type: 'power_strength_speed', percentage: 78, sets: '4', reps: '3', rest: '3m', unit: 'reps', targetVelocity: '1.10', peakVelocity: '1.65', velocityLoss: '10%' },
    { id: 'vbt8', title: 'Power Clean from Floor (Peak Power)', details: 'Full power clean from floor @ 80% 1RM. Target Mean: 1.05 m/s, Peak: 1.55 m/s. 10% cutoff rule for maximal CNS recruitment.', type: 'power_strength_speed', percentage: 80, sets: '4', reps: '2', rest: '3m', unit: 'reps', targetVelocity: '1.05', peakVelocity: '1.55', velocityLoss: '10%' },
    { id: 'vbt9', title: 'Clean High Pull from Blocks', details: 'Explosive shrug and high pull from knee-level blocks @ 85% 1RM clean. Target Mean: 1.15 m/s, Peak: 1.70 m/s. 10% cutoff.', type: 'power_strength_speed', percentage: 85, sets: '4', reps: '3', rest: '2.5m', unit: 'reps', targetVelocity: '1.15', peakVelocity: '1.70', velocityLoss: '10%' },
    { id: 'vbt10', title: 'Dynamic Effort Box Squats with Bands', details: 'Box squat @ 60% bar weight + 20% accommodating band tension. Target Mean: 0.85-0.95 m/s. 10% cutoff for sprint acceleration RFD.', type: 'power_strength_speed', percentage: 60, sets: '6', reps: '2', rest: '75s', unit: 'reps', targetVelocity: '0.90', peakVelocity: '1.40', velocityLoss: '10%' },
    { id: 'vbt11', title: 'Push Press / Jerk Drive (Peak Velocity)', details: 'Explosive dip and drive overhead @ 75% 1RM. Target Mean: 1.15 m/s, Peak: 1.70 m/s. 10% cutoff rule.', type: 'power_strength_speed', percentage: 75, sets: '4', reps: '3', rest: '2m', unit: 'reps', targetVelocity: '1.15', peakVelocity: '1.70', velocityLoss: '10%' },

    // 4. Accelerative Strength (0.50 - 0.75 m/s)
    { id: 'vbt12', title: 'Heavy Half-Squat (Accelerative Strength)', details: 'Half-squat @ 75-80% 1RM. Target Mean: 0.60-0.70 m/s. 15% velocity loss cutoff. High force production with sprint specific knee angles.', type: 'strength_accelerative', percentage: 78, sets: '4', reps: '4', rest: '3m', unit: 'reps', targetVelocity: '0.65', peakVelocity: '1.05', velocityLoss: '15%' },
    { id: 'vbt13', title: 'Heavy Full Back Squat (Accelerative Strength)', details: 'Full squat @ 80% 1RM. Target Mean: 0.55 m/s, Peak: 0.85 m/s. 15% velocity loss cutoff.', type: 'strength_accelerative', percentage: 80, sets: '4', reps: '4', rest: '3m', unit: 'reps', targetVelocity: '0.55', peakVelocity: '0.85', velocityLoss: '15%' },
    { id: 'vbt14', title: 'Heavy Trap Bar Deadlift (High Force)', details: 'Trap bar deadlift @ 80% 1RM. Target Mean: 0.55-0.65 m/s. 15% cutoff. Overloads posterior chain extension.', type: 'strength_accelerative', percentage: 80, sets: '4', reps: '3', rest: '3m', unit: 'reps', targetVelocity: '0.60', peakVelocity: '0.90', velocityLoss: '15%' },

    // 5. Maximal / Absolute Strength (< 0.50 m/s)
    { id: 'vbt15', title: 'Maximal Strength Squat (Heavy Grind)', details: 'Full squat @ 90% 1RM. Target Mean: 0.38-0.42 m/s. 20% velocity loss cutoff to maintain motor unit synchronization.', type: 'strength_maximal', percentage: 90, sets: '3', reps: '2', rest: '4m', unit: 'reps', targetVelocity: '0.40', peakVelocity: '0.65', velocityLoss: '20%' },
    { id: 'vbt16', title: 'Maximal Strength Bench Press (Heavy Grind)', details: 'Bench press @ 90% 1RM. Target Mean: 0.32-0.36 m/s. 20% velocity loss cutoff.', type: 'strength_maximal', percentage: 90, sets: '3', reps: '2', rest: '3.5m', unit: 'reps', targetVelocity: '0.34', peakVelocity: '0.55', velocityLoss: '20%' }
  ],
  templates: [
    {
      id: 'tpl1',
